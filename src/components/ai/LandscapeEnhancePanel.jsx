...
export default function LandscapeEnhancePanel({ defaultStrength = 50, onStrengthChange }) {
  ...
  return (
    <div>
      ...
      <div style={{ fontSize: '0.85rem', opacity: 0.8, marginTop: 6 }}>
        Enhances sky clarity/hue and ground vibrance/texture; balances global tone.
      </div>
    </div>
  );
}
